...
class Enemy(Entity):
    def __init__(self, **kwargs):
        super().__init__(parent=shootables_parent, model='cube', scale_y=2, origin_y=-.5, color=color.light_gray, collider='box', **kwargs, texture = '세균맨.jpg')
...
# Enemy()
enemies = [Enemy(x=x*3) for x in range(10)]
